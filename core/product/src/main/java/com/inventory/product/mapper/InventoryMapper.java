...
public interface InventoryMapper {
  ...
  @Mapping(target = "schemePayFor", source = "schemePayFor")
  @Mapping(target = "schemeFree", source = "schemeFree")
  @Mapping(target = "schemePercentage", source = "schemePercentage")
  @Mapping(target = "purchaseSchemeType", source = "purchaseSchemeType")
  @Mapping(target = "purchaseSchemePayFor", source = "purchaseSchemePayFor")
  @Mapping(target = "purchaseSchemeFree", source = "purchaseSchemeFree")
  @Mapping(target = "purchaseSchemePercentage", source = "purchaseSchemePercentage")
  @Mapping(target = "purchaseAdditionalDiscount", source = "purchaseAdditionalDiscount")
  @Mapping(target = "thresholdCount", source = "thresholdCount")
  @Mapping(target = "sgst", source = "sgst")
  @Mapping(target = "cgst", source = "cgst")
