...
import com.inventory.user.rest.dto.response.AcceptJoinRequestResponse;
...
public interface JoinRequestMapper {
  ...
  default OwnerShopDto toOwnerShopDto(String shopId, String shopName) {
    return new OwnerShopDto(shopId, shopName != null ? shopName : shopId);
  }

  default OwnerShopListResponse toOwnerShopListResponse(java.util.List<OwnerShopDto> shops) {
    return new OwnerShopListResponse(shops != null ? shops : java.util.List.of());
  }
