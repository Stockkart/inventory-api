...
/**
 * {@code b2ba} -- an amendment tab. It restates an invoice from an earlier period that has since been corrected, and nothing in the platform tracks a revision against its original.
 *
 ...
 */
public class Gstr1B2baTabWriter implements Gstr1TabWriter {

  private static final String SHEET_NAME = "b2ba";
  ...
  public void write(Workbook workbook, Gstr1ReportContext context) {
    ...
    int rowNum = 0;
    sheet.createRow(rowNum++).createCell(0).setCellValue("Summary For B2BA");
