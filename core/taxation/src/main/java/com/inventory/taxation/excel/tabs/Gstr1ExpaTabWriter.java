...
/**
 * {@code expa} -- an amendment tab. It restates an invoice from an earlier period that has since been corrected, and nothing in the platform tracks a revision against its original.
 *
 ...
 */
public class Gstr1ExpaTabWriter implements Gstr1TabWriter {

  private static final String SHEET_NAME = "expa";
  ...
  public void write(Workbook workbook, Gstr1ReportContext context) {
    ...
    int rowNum = 0;
    sheet.createRow(rowNum++).createCell(0).setCellValue("Summary For EXPA");
