...
/**
 * {@code ecoab2b} -- supplies made through an e-commerce operator under section 9(5), which the platform does not model.
 *
 ...
 */
public class Gstr1Ecoab2bTabWriter implements Gstr1TabWriter {

  private static final String SHEET_NAME = "ecoab2b";
  ...
  public void write(Workbook workbook, Gstr1ReportContext context) {
    ...
    int rowNum = 0;
    sheet.createRow(rowNum++).createCell(0).setCellValue("Summary For Supplies U/s 9(5) - 15A-B2B");
