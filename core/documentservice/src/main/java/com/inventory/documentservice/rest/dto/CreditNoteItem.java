...
public class CreditNoteItem {
   ...
   *
   * <p>Formatted here rather than in the template because the two roles read different fields
   * for it -- a sale scheme and a purchase scheme are different deals on the same goods -- and a
   * template deciding that would have to know which document it is rendering.
   */
